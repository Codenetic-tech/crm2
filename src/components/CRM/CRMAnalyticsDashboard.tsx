...
const CRMAnalyticsDashboard: React.FC = () => {
  ...
  // Filter leads by selected campaign, assigned user, and hierarchy
  const filteredLeads = React.useMemo(() => {
    ...
    return filtered;
  }, [leads, selectedCampaign, selectedAssignedUser, getSelectedEmails]);
    ...
    <div className="min-h-screen ml-[30px]">
      ...
      {!isInitialLoading && Array.isArray(leads) && leads.length > 0 && (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <CampaignLeadSourceChart leads={leads} />
